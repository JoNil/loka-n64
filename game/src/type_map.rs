...
pub struct OccupiedEntry<'a, T> {
    data: hash_map::OccupiedEntry<'a, TypeId, Box<dyn Any>, BuildFnvHasher>,
...
pub struct VacantEntry<'a, T> {
    data: hash_map::VacantEntry<'a, TypeId, Box<dyn Any>, BuildFnvHasher>,
    marker: PhantomData<fn(T)>,
}
...
pub struct TypeMap {
    map: Option<HashMap<TypeId, Box<dyn Any>, BuildFnvHasher>>,
}
