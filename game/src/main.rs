    ...
    loop {
...

        {
            ...
            let (colored_rect_count, textured_rect_count) = {
                ...
                font::draw_text(&mut cb, "UVWXYZ", Vec2::new(1.0, 85.0));
                font::draw_text(&mut cb, "[\\]^_`", Vec2::new(1.0, 102.0));
                font::draw_text(&mut cb, "abcdefghij", Vec2::new(1.0, 119.0));
                font::draw_text(&mut cb, "klmnopqrst", Vec2::new(1.0, 136.0));
                font::draw_text(&mut cb, "uvwxyz", Vec2::new(1.0, 153.0));
                font::draw_text(&mut cb, "{|}~", Vec2::new(1.0, 170.0));
